...
COMMONOBJECTS = Display.o Simulator.o BreakoutSimulator.o Shape.o Ball.o Paddle.o Brick.o BrickGenerator.o LiveDisplay.o PowerUp.o BallPowerUpFactory.o PaddlePowerUpFactory.o
OBJECTS = main.o
TESTOBJS = mainTest.o
CC = g++
